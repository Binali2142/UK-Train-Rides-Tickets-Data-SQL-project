...
-- This is basic sql project as data analyst.

--Mock train ticket data for National Rail in the UK, 
--from Jan to Apr 2024, including details on the type of ticket, 
--the date & time for each journey, the departure & arrival stations, 
--the ticket price, and more.
